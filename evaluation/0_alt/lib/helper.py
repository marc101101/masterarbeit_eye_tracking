...
def get_distance_to_cross_hair(self):
        p1 = np.array([self.cross_hair_x, self.cross_hair_y, self.cross_hair_z])
        p2 = np.array([0, 0, 0])
...
def show_images(sp1, sp2, sp3):
    img1 = mpimg.imread('../4_Bilder/1_Modell/front.png')
    sp1.imshow(img1, origin='lower')

    img2 = mpimg.imread('../4_Bilder/1_Modell/top.png')
    sp2.imshow(img2, origin='lower')

    img3 = mpimg.imread('../4_Bilder/1_Modell/side.png')
